		...
		<nav>
			<ul class="dropdown">
				...
				<div class="dropdown-content">
					...
					<a href="fotografias.jsp"><b>Fotografías</b></a>
				</div>
			</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<img src="imagenes/madrid-328121_1280 - copia.jpg"
						class="fotografia1">
				</div>
				<div class="col-lg-6 col-md-6 col-12">
					<img src="imagenes/jacket-4297814_1280 - copia.jpg"
						class="fotografia2">
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-lg-6 col-md-4 col-12">
					<img src="imagenes/bullfighter-7166334_1280 - copia.png"
						class="fotografia3">
				</div>
				<div class="col-lg-3 col-md-4 col-12">
					<img src="imagenes/plaza-toros-212198_1280 - copia.jpg"
						class="fotografia4">
				</div>
				<div class="col-lg-3 col-md-4 col-12">
					<img src="imagenes/bullring-187844_1280 - copia.jpg"
						class="fotografia5">
				</div>
			</div>
			<div class="row">
				<div class="offset-lg-6 col-lg-6 col-md-6 col-12">
					<img src="imagenes/torero-1078423_1280 - copia.jpg"
						class="fotografia6">
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-4 col-12">
					<img src="imagenes/torero-3276656_1280 - copia.jpg"
						class="fotografia7">
				</div>
				<div class="col-lg-8 col-md-8 col-12">
					<img src="imagenes/torero-389344_1280 - copia.jpg"
						class="fotografia8">
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-4 col-12">
					<img
						src="imagenes/diego-gomez-tejedor-NPHM_wX0Fq8-unsplash - copia.jpg"
						class="fotografia9">
				</div>
				<div class="col-lg-8 col-md-8 col-12">
					<img src="imagenes/annie-spratt-FCi5n8XVwmY-unsplash - copia.jpg"
						class="fotografia10">
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-12">
					<img
						src="imagenes/paul-kenny-mcgrath-kf_fCURx3_E-unsplash - copia.jpg"
						class="fotografia11">
				</div>
			</div>
		</div>
