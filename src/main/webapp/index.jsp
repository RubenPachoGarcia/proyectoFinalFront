						...
						<div class="containerFormulario2">
							<form>
								<div class="rowForm">
									...
									<div class="colForm col-lg-6 col-md-6 col-12">
										<label for="foto" class="labelForm">Foto</label> <input
								...
								<div class="rowForm">
									<div class="colForm col-lg-6 col-md-6 col-12">
										<label for="email" class="labelForm">Correo
											electrónico</label> <input type="email" class="input">
									</div>
									<div class="colForm col-lg-6 col-md-6 col-12">
										<label for="contrasenia" class="labelForm">Contraseña</label>
								...
								<div class="rowForm">
									<div class="colForm col-lg-6 col-md-6 col-12">
										<label for="telefono" class="labelForm">Teléfono</label> <input
											type="number" class="input">
									</div>
									<div class="colForm col-lg-6 col-md-6 col-12">
										<label for="repetir-contrasenia" class="labelForm">Repetir
